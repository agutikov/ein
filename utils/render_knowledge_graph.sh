#!/usr/bin/env bash
#
# Render docs/lib/knowledge-graph.dot into SVG (or another Graphviz
...
#   $3  output path    (ignored when engine=all)            default: docs/lib/knowledge-graph.<fmt>
#
# Engine notes:
...
SRC="${REPO_ROOT}/docs/lib/knowledge-graph.dot"
