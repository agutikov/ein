#!/usr/bin/env python3
"""
Render docs/lib/knowledge-graph.dot into a Cytoscape.js view.

Produces, under docs/lib/knowledge-graph.cy/ :
...
SRC_DOT   = REPO_ROOT / "docs" / "lib" / "knowledge-graph.dot"
OUT_DIR   = REPO_ROOT / "docs" / "lib" / "knowledge-graph.cy"
