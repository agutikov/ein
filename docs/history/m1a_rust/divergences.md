...
> [S1a.10.5](README.md#s1a105--the-removal). The phase's
...
Empty was the goal at the [P1a.5](README.md#p1a5--presentation-and-cli) byte gate; a
...
[S1a.10.1](README.md#s1a101--bank-what-only-the-oracle-proves)**, the
stage that banks what only the oracle proves. Each entry's disposition after
the second engine leaves is
[`oracle_ledger.md` §8](oracle_ledger.md#8-the-divergence-ledger-re-read):
...
**Found:** 2026-08-18, [S1a.3.1](README.md#s1a31--the-pattern-compiler)
...
**Found:** 2026-08-18, [S1a.4.3](README.md#s1a43--apriori-candidate-generation-and-the-no-good-store)
...
**Since [S1a.10.2](README.md#s1a102--port-the-python-test-suite)
...
raises is [the ledger's §8](oracle_ledger.md#8-the-divergence-ledger-re-read):
...
[S1a.6.6](README.md#s1a66--the-differential-fuzzer)'s fuzzer.** The
...
**Found:** 2026-08-19, [S1a.6.9](README.md#s1a69--the-fork-entry-delta-the-resumed-saturator)
**Tier:** T2 and T3 — and as of
[S1a.6.10](README.md#s1a610--the-parity-contract-relaxes-answers-not-narration) **neither reports
...
[S1a.6.11](README.md#s1a611--einrss-own-fixtures-for-what-parity-stopped-comparing) there are twelve
...
**history**: [S1a.10.2](README.md#s1a102--port-the-python-test-suite)
...
[S1a.6.10](README.md#s1a610--the-parity-contract-relaxes-answers-not-narration) is where it became
...
2026-08-20 by [S1a.6.6](README.md#s1a66--the-differential-fuzzer)'s
...
[S1a.6.6](README.md#s1a66--the-differential-fuzzer)'s fuzzer.** If a
...
> **Re-attributed at [S1a.10.4](README.md#s1a104--utils-re-aimed-at-one-engine),
