...
> [oracle ledger](../oracle_ledger.md) §1, row by
> row.
>
...
> because [the ledger §5](../oracle_ledger.md#5-what-the-successor-found)
...
[`parity_baselines.md`](../../../kernel/inference/parity_baselines.md)
...
T3 is what "drop-in replacement" means. It is the [P1a.5](../README.md#p1a5--presentation-and-cli)
gate.
...
| phase | gate |
|---|---|
| [P1a.1](../README.md#p1a1--ir-frontend) | T3 on parse/dump/render surfaces only |
| [P1a.2](../README.md#p1a2--kb-core) | T3 on load errors; T1-shaped KB-structure diff |
| [P1a.3](../README.md#p1a3--deductive-core) | T2 on saturation-only fixtures (`examples/saturation/**`, `features/**`) |
| [P1a.4](../README.md#p1a4--search-layer) | T1 corpus-wide, T2 on `branching/**` + `lattice/**` + `domain_elim/**` |
| [P1a.5](../README.md#p1a5--presentation-and-cli) | **T3 corpus-wide** |
| [P1a.6](../README.md#p1a6--performance)–[P1a.9](../README.md#p1a9--release) | T3 stays green; regressions are release blockers |
...
> planned as [S1a.0.2](../README.md#s1a02--the-oracle-event-protocol),
...
[S1a.6.10](../README.md#s1a610--the-parity-contract-relaxes-answers-not-narration) the same decision
...
`docs/history/m1a_rust/divergences.md` (created in P1a.0) records every
...
- [`docs/kernel/inference/parity_baselines.md`](../../../kernel/inference/parity_baselines.md)
...
- [P1a.0 stages](../README.md#p1a0--conformance-harness-and-shared-assets) — where this is
  built.
