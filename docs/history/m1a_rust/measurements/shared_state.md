...
[S1a.7.1](../README.md#s1a71--making-the-shared-state-sync)'s measurements, in
...
| `PlanMemo` | `RwLock`, double-checked insert | already true — it has been `Arc<Mutex<PlanMemo>>` since [S1a.6.8](../README.md#s1a68--the-compile-cache-and-the-extent-counts) |
...
it.** [README § Risks](../README.md#p1a7--parallelism) sizes `--jobs N` by a fork's ~6 KB
...
[S1a.7.2](../README.md#s1a72--level-1-parallel-enterings) owes anyway for its own reasons.
...
6. ~~**`&mut Terms` is still threaded through 99 signatures**~~ — **settled
   2026-08-22 at [S1a.7.2](../README.md#s1a72--level-1-parallel-enterings) T1a.7.2.1, and not
...
7. **Nothing this phase builds can perturb an id**, which is the corollary of
   ...
   ([T1a.7.1.5](../README.md#s1a71--making-the-shared-state-sync))
...
**The bound to carry into [S1a.7.2](../README.md#s1a72--level-1-parallel-enterings).** The
