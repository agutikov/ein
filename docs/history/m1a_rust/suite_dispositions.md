...
**Stage:** [S1a.10.2](README.md#s1a102--port-the-python-test-suite) · **Phase:** [P1a.10](README.md#p1a10--one-implementation) · **Written:** 2026-08-20
...
2. **Six ported claims did not run.** They compiled and asserted nothing, or
   ...
   [deferred syntax](../../kernel/ir/03-ein-lang/05_inspirations.md));
