...
**Stage:** [S1d.10.6](README.md#s1d106--the-traversal) — [T1d.10.6.1](README.md#s1d106--the-traversal), written 2026-08-26
...
[README §1](README.md#p1d10--exhaustive-search):
...
[the reconnaissance's table](README.md#p1d10--exhaustive-search)
...
running on the same rung. Since [S1d.2.5](hypotheses_from_obligations.md)
...
[S1d.3.1](model_set_census.md)'s `EIN_LEFTOVER=1` probe is
...
[S1d.2.5 §6](hypotheses_from_obligations.md) settled by
...
[S1d.10.5](README.md#s1d105--what-exhausted-means)'s vocabulary and not for this stage — but it is
...
- The comparison that would catch a regression is therefore **not** tree-vs-
  ...
  [T1d.10.6.5](README.md#s1d106--the-traversal)
  already asks for.
