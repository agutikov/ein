...
![Clustered with two-direction arcs](files/clustered.svg)



Grouping by type with relations "is instance of" and "is type of".
![Link type example](files/link_type.svg)

Simplify view by reducing bi-directional links.
![Link type example simple](files/link_type_2.svg)
...
Apriori relations.
![Apriori relations](files/apriori_relations.svg)


Grouping by links to "type" nodes and simplified bi-directional links.
![Linked with type nodes](files/linked.svg)
...
![House color constraint](files/single_attribute_constraint.svg)
...
![House color constraint](files/inference_triangle.svg)


### Square inference rule.
Applicable (in this case) for spatial relations: right and next.
![House color constraint](files/inference_square.svg)
![House color constraint](files/inference_square_2.svg)
...
![House color constraint](files/hgen.svg)
...
![House color constraint](files/htest_1.svg)
