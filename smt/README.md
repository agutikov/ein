...
than for the graph engine. [M1c P1c.2](../plans/m1c_external_validation/p1c.2_external_benchmarks/README.md)
...
> needed it — P1c.2's benchmark uses **CVC5**, which is a different program
