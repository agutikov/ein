...
synthesis* ([M2b](plans/m2b_presentation/README.md)).
...
| [**M2b**](plans/m2b_presentation/README.md) — paper + presentation | *From the Zebra puzzle to autoformalization*: comparison against the field, benchmarks, the growth directions as future work | parked; placeholder with the outline |
...
| [`plans/`](plans/README.md) | the roadmap: milestones M1a–M2b, `followups/`, `ideas/`, open questions |
