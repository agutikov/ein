...
- **Lower bounds are reported but still have no force.** `total` /
  ...
  recorded nothing ([M1d § what the note says](plans/m1d_satisfiability/README.md#what-the-note-says-the-engine-is-missing)).
