# S10.1 — The problem corpus, and what a fair encoding is
...
| `zebra2-minus-15` | **32 models** — the entry where *counting* separates the systems, and [M1d](../../docs/history/m1d_satisfiability/README.md)'s subject | [`examples/zebra2-minus-15.ein`](../../examples/zebra2-minus-15.ein) |
...
5. **The answer's printed form is declared** with the encoding, because
   [S10.4](s10.4_answers_not_only_times.md) has to parse it into a
   canonical form.
...
### Task T10.1.1 — The manifest and the catalog
### Task T10.1.2 — The zebra family, per system
...
### Task T10.1.3 — n-queens: the generator, the ein encoding, the rivals
...
### Task T10.1.4 — The fairness rules, written down
### Task T10.1.5 — What is not in the corpus
...
- `zebra2-minus-15` is the entry that justifies the whole exercise: it is the
  ...
  [M1d](../../docs/history/m1d_satisfiability/README.md) starts arguing about how to get
  there.
