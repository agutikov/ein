...
| F14 | Saturation and satisfiability — **promoted**                       | **promoted 2026-08-21 → [M1d](../m1d_satisfiability/README.md)**, at the user's direction. The note is now [`plans/m1d_satisfiability/ideas.md`](../m1d_satisfiability/ideas.md) and its argument is the milestone's [§ What the note says the engine is missing](../m1d_satisfiability/README.md#what-the-note-says-the-engine-is-missing) plus phase [P1d.2](../m1d_satisfiability/p1d.2_obligations/README.md). Nothing is parked here any more |
...
- If a followup starts to acquire concrete tasks, promote it: move
  ...
  [`m1d_satisfiability/ideas.md`](../m1d_satisfiability/ideas.md) on
