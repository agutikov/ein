# D2 — Q6: moved to P1e.1b as a stage
...
| which decline condition to construct, and the C4 sketch | [S1e.1b.6](../../p1e.1b_hypothesis_structure/s1e.1b.6_obligations_under_hypothesis.md) T2 |
| the loss mechanism, and the two-part assertion | [S1e.1b.6](../../p1e.1b_hypothesis_structure/s1e.1b.6_obligations_under_hypothesis.md) § The loss mechanism |
| what the search should **do** with the new obligation | [Q-M1e.11](../../open_questions.md#q-m1e11--what-happens-to-an-obligation-derived-under-a-hypothesis), ruled on by S1e.1b.6 T4 |
| the review's `Q6`, as a question of this milestone | still `Q6`; its answering stage is now S1e.1b.6 |
...
[P1e.1b](../../p1e.1b_hypothesis_structure/README.md)'s subject and nothing
...
- [D7](d7_the_diff_instrument.md) — the two-config diff. S1e.1b.6 T3 and
  S1e.1b.7 are two more customers for it, which strengthens the case D7 makes.
- [D8](d8_branching06_untyped_models.md) — `branching/06`'s junk candidates are
  what make `complete` change meaning under the blind rung, which is S1e.1b.6's
  loss mechanism.
