...
**Phase:** [P1a.2](../p1a.2_kb_core/README.md).
...
The profile in the [milestone README](../README.md#baseline--what-einrs-has-to-beat)
...
[P1a.6](../p1a.6_performance/README.md)); `state_key` becomes a sorted
...
that do not exist yet: [P1a.7](../p1a.7_parallelism/README.md) wants
...
[F11](../../followups/f11_deductive_layer_perf.md) parks D1 on.
...
reserved for [F4](../../followups/f4_cross_cutting.md)'s e-graph). ein.rs
