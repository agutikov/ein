...
**Phase:** [P1a.4](../p1a.4_search_layer/README.md).
...
is the constant factor and, in [P1a.7](../p1a.7_parallelism/README.md),
the parallelism.
...
- Because it runs the matcher, it inherits [05](05_matcher.md)'s speedup
  ...
  [`features.md`](../../../docs/kernel/inference/features.md)'s matrix
  against ein.rs in [P1a.6](../p1a.6_performance/README.md) and record the
...
- The [`features.md`](../../../docs/kernel/inference/features.md) lever
...
- [F9 ledger](../../followups/f9_e_catalog.md) — what not to try again.
