...
[S1a.6.4](../p1a.6_performance/s1a.6.4_hypgen_and_lattice.md) added two more,
...
[S1a.6.12](../p1a.6_performance/s1a.6.12_boundary_and_snapshot.md) added no new
...
| — | ein.rs P1a.6 (optimised, `--jobs 1`) | — | — | — | target ≤ 0.2 s / ≤ 0.4 s / ≤ 5 s — **all four met**, with **88 %** of headroom on the tightest and the two `-e` cells at **157×** and **175×** PyPy. No block of `zebra -e` is above 8 % of self time any more; the largest is the enqueue path, which is [S1a.6.7](../p1a.6_performance/s1a.6.7_relever_matrix.md)'s subject |
| — | ein.rs P1a.7 (`--jobs 8`) | — | — | — | — |
