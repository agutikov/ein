...
- The whole P1.7 is the operational check that
  [idea 05](../../ideas/05-zebra-puzzle-graph-reasoner.md) and
  [idea 06](../../ideas/06-inference-rules-completeness.md)
  produced an implementable design.
- [Idea 08 §The target trace](../../ideas/08-human-style-deductive-trace.md#the-target-trace-paraphrased)
  is the canonical regression target.
- [Idea 03](../../ideas/03-three-task-classes.md) — all three
