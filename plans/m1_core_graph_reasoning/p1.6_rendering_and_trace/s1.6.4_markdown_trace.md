...
**Implements idea:** [08 §Target trace](../../ideas/08-human-style-deductive-trace.md#the-target-trace-paraphrased)
+ [08 §What the implementation needs](../../ideas/08-human-style-deductive-trace.md#what-the-implementation-needs-implied-by-the-trace).
...
match the [target walkthrough](../../ideas/08-human-style-deductive-trace.md#the-target-trace-paraphrased).
...
- `{a}`, `{b}`, ... — bound variable names (using puzzle entity
  ...
  [idea 08 §Naming](../../ideas/08-human-style-deductive-trace.md#why-this-is-a-hard-problem)).
