...
- Why SMT proof traces aren't useful as-is:
  [02-solvers-csp-sat-smt.md](../../docs/lib/02-solvers-csp-sat-smt.md) §2 +
  [11-search-optimization-algorithms.md](../../docs/lib/11-search-optimization-algorithms.md) §1.
- Tableau / natural deduction style of proofs:
  [03-theorem-proving-formal-methods.md](../../docs/lib/03-theorem-proving-formal-methods.md) §4.
