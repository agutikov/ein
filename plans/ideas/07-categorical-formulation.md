...
- CT primitives, diagram languages, monoidal/string-diagram
  variants: [05-category-theory.md](../../docs/lib/05-category-theory.md).
- DPO/SPO graph rewriting:
  [05-category-theory.md](../../docs/lib/05-category-theory.md) §5,
  [06-graphs-rewrite-systems.md](../../docs/lib/06-graphs-rewrite-systems.md) §4.
- Catlab.jl as a possible host for a categorical IR:
  [04-programming-languages.md](../../docs/lib/04-programming-languages.md) §5.
